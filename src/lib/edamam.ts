...
function getMockFoods(query: string): EdamamFood[] {
  const mockDb: EdamamFood[] = [
    ...
    { foodId: 'camembert', label: 'Camembert', calories: 300, protein: 20, carbs: 0.5, fat: 24 },
    { foodId: 'brie', label: 'Brie', calories: 334, protein: 21, carbs: 0.5, fat: 28 },
    { foodId: 'gruyere', label: 'Gruyère', calories: 413, protein: 30, carbs: 0.4, fat: 32 },
    { foodId: 'parmesan', label: 'Parmesan', calories: 431, protein: 38, carbs: 3.2, fat: 29 },
    { foodId: 'roquefort', label: 'Roquefort', calories: 369, protein: 22, carbs: 2, fat: 31 },
    { foodId: 'comte', label: 'Comté', calories: 407, protein: 27, carbs: 0.4, fat: 33 },
    { foodId: 'feta', label: 'Feta', calories: 264, protein: 14, carbs: 4, fat: 21 },
    { foodId: 'ricotta', label: 'Ricotta', calories: 174, protein: 11, carbs: 3, fat: 13 },
    { foodId: 'gouda', label: 'Gouda', calories: 356, protein: 25, carbs: 2.2, fat: 28 },
    // Yaourts aromatisés
    { foodId: 'yaourt_vanille', label: 'Yaourt à la vanille', calories: 90, protein: 3.5, carbs: 14, fat: 2.5 },
    { foodId: 'yaourt_fraise', label: 'Yaourt à la fraise', calories: 88, protein: 3.2, carbs: 15, fat: 2 },
    { foodId: 'yaourt_peche', label: "Yaourt à la pêche", calories: 85, protein: 3.1, carbs: 14, fat: 2 },
    { foodId: 'yaourt_citron', label: 'Yaourt au citron', calories: 87, protein: 3.3, carbs: 14, fat: 2.2 },
    { foodId: 'yaourt_cerise', label: 'Yaourt à la cerise', calories: 89, protein: 3.2, carbs: 15, fat: 2 },
    { foodId: 'yaourt_chocolat', label: 'Yaourt au chocolat', calories: 105, protein: 3.8, carbs: 16, fat: 3.2 },
    // Légumes supplémentaires
    { foodId: 'mais', label: 'Maïs en grains', calories: 86, protein: 3.2, carbs: 19, fat: 1.2 },
    { foodId: 'mais_conserve', label: 'Maïs en conserve', calories: 78, protein: 2.5, carbs: 17, fat: 0.9 },
    { foodId: 'betterave', label: 'Betterave cuite', calories: 43, protein: 1.6, carbs: 10, fat: 0.2 },
    { foodId: 'betterave_crue', label: 'Betterave crue', calories: 43, protein: 1.6, carbs: 10, fat: 0.2 },
    { foodId: 'lentilles_vertes', label: 'Lentilles vertes cuites', calories: 116, protein: 9, carbs: 20, fat: 0.4 },
    { foodId: 'lentilles_corail', label: 'Lentilles corail cuites', calories: 100, protein: 7.6, carbs: 17, fat: 0.4 },
    { foodId: 'oignon', label: 'Oignon', calories: 40, protein: 1.1, carbs: 9, fat: 0.1 },
    { foodId: 'oignon_rouge', label: 'Oignon rouge', calories: 40, protein: 1.1, carbs: 9, fat: 0.1 },
    { foodId: 'oignon_frits', label: 'Oignons frits', calories: 398, protein: 5, carbs: 38, fat: 25 },
    // Charcuterie
    { foodId: 'lardons', label: 'Lardons fumés', calories: 337, protein: 16, carbs: 0.5, fat: 30 },
    { foodId: 'lardons_allumes', label: 'Lardons allumettes', calories: 310, protein: 17, carbs: 0.5, fat: 27 },
